...
if {[file isfile predict_kernel.autotvin.dat]} {
	file delete -force predict_kernel.autotvin.dat
}

if {[file isfile predict_kernel.autotvout.dat]} {
	file delete -force predict_kernel.autotvout.dat
}
