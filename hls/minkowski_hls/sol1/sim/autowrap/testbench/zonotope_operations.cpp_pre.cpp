# 1 "/home/zzh/minkowski_fpga/hls/src/zonotope_operations.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 419 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/zzh/minkowski_fpga/hls/src/zonotope_operations.cpp" 2
# 1 "/home/zzh/minkowski_fpga/hls/src/../include/zonotope.hpp" 1
# 17 "/home/zzh/minkowski_fpga/hls/src/../include/zonotope.hpp"
using data_t = float;
...
# 2 "/home/zzh/minkowski_fpga/hls/src/zonotope_operations.cpp" 2
...
# 3 "/home/zzh/minkowski_fpga/hls/src/zonotope_operations.cpp" 2
...
# 4 "/home/zzh/minkowski_fpga/hls/src/zonotope_operations.cpp" 2
...
void compute_lambda_segment(
    ...
    if (std::fabs(denom) < 1e-12) {
        ...
        for (int i = 0; i < 4; ++i) lambda[i] = HHT_c[i] / denom;
    }
}
...
void compute_lambda_p_radius(
    ...
    data_t term1 = vec4_dot(HHTc, PHHTc);

    data_t Pc[4];
    mat4_mul(P, c, Pc);
    data_t term2 = (phi * phi) * vec4_dot(c, Pc);
...
void compute_lambda_volume(
    ...
    for (int s = 0; s < N_SCAN; ++s) {
        ...
        data_t lam[4];
        for (int i = 0; i < 4; ++i) lam[i] = alpha * c[i];
    ...
    for (int i = 0; i < 4; ++i) lambda[i] = best_alpha * c[i];
}
# 236 "/home/zzh/minkowski_fpga/hls/src/zonotope_operations.cpp"
