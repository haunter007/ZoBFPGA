...
// 
// ==============================================================
# 1 "/home/zzh/minkowski_fpga/hls/src/fpga_kernels.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 419 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/zzh/minkowski_fpga/hls/src/fpga_kernels.cpp" 2
...
# 5 "/home/zzh/minkowski_fpga/hls/include/kernels.hpp" 2
...
# 2 "/home/zzh/minkowski_fpga/hls/src/fpga_kernels.cpp" 2
...
# 3 "/home/zzh/minkowski_fpga/hls/src/fpga_kernels.cpp" 2
# 1 "/opt/Xilinx/2025.2/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 1 3
# 36 "/opt/Xilinx/2025.2/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 3
...
# 37 "/opt/Xilinx/2025.2/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 2 3
...
using std::tgamma;
using std::trunc;
# 4 "/home/zzh/minkowski_fpga/hls/src/fpga_kernels.cpp" 2
...
# 5 "/home/zzh/minkowski_fpga/hls/src/fpga_kernels.cpp" 2
...
void predict_kernel(
    ...
    (static_cast <bool> (m_x >= 0 && m_x <= 32) ? void (0) : __assert_fail ("m_x >= 0 && m_x <= MAX_GEN", __builtin_FILE (), __builtin_LINE (), __extension__ __PRETTY_FUNCTION__));
    (static_cast <bool> (m_w >= 0 && m_w <= 32) ? void (0) : __assert_fail ("m_w >= 0 && m_w <= MAX_GEN", __builtin_FILE (), __builtin_LINE (), __extension__ __PRETTY_FUNCTION__));
    (static_cast <bool> (m_x + m_w <= 32) ? void (0) : __assert_fail ("m_x + m_w <= MAX_GEN", __builtin_FILE (), __builtin_LINE (), __extension__ __PRETTY_FUNCTION__));
...
extern "C"
#endif
void apatb_predict_kernel_ir(const float *, const float (*)[32], int, const float (*)[4], const float *, const float (*)[32], int, float *, float (*)[32], int *);
#ifdef __cplusplus
extern "C"
#endif
void predict_kernel_hw_stub(const float *p_x, const float (*H_x)[32], int m_x, const float (*A)[4], const float *p_w, const float (*H_w)[32], int m_w, float *p_pred, float (*H_pred)[32], int *m_pred){
predict_kernel(p_x, H_x, m_x, A, p_w, H_w, m_w, p_pred, H_pred, m_pred);
return ;
}
#ifdef __cplusplus
extern "C"
...
extern "C"
#endif
void apatb_predict_kernel_sw(const float *p_x, const float (*H_x)[32], int m_x, const float (*A)[4], const float *p_w, const float (*H_w)[32], int m_w, float *p_pred, float (*H_pred)[32], int *m_pred){
refine_signal_handler();
apatb_predict_kernel_ir(p_x, H_x, m_x, A, p_w, H_w, m_w, p_pred, H_pred, m_pred);
return ;
}
#endif
# 68 "/home/zzh/minkowski_fpga/hls/src/fpga_kernels.cpp"
...
void row_sum_abs_kernel(
    const data_t H_drop[4][32],
    int m_drop,
    data_t row_sum[4]
) {
    for (int i = 0; i < 4; ++i) row_sum[i] = 0.0;
