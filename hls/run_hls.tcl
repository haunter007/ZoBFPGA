...
#
# Examples:
#   HLS_CFLAGS="-DTEST=1" vitis_hls run_hls.tcl csim minkowski_hls predict_kernel xck26-sfvc784-2LV-c 100 src/kernels_hls.cpp src/testbench.cpp
#   HLS_CFLAGS="-DTEST=1" vitis_hls run_hls.tcl synth minkowski_hls predict_kernel xilinx_kr260 300 src/kernels_hls.cpp src/testbench.cpp
...
set extra_tb_rel [list "src/zonotope_operations.cpp" "src/dump.cpp"]
