...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "predict_kernel.autotvin.dat"
	set constFileTvOut       "predict_kernel.autotvout.dat"
	set constFileHdlTvIn     "predict_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "predict_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
