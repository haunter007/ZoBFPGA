...
$(ObjDir)/dump.cpp_pre.cpp.tb.o : dump.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling dump.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/zonotope_operations.cpp_pre.cpp.tb.o : zonotope_operations.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling zonotope_operations.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \
...
$(ObjDir)/fpga_kernels.cpp_pre.cpp.tb.o : fpga_kernels.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fpga_kernels.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
