...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler predict_kernel_sparsemux_9_2_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln37_1 \
    op interface \
    ports { bitcast_ln37_1 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln37_2 \
    op interface \
    ports { bitcast_ln37_2 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln37_3 \
    op interface \
    ports { bitcast_ln37_3 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln40 \
    op interface \
    ports { bitcast_ln40 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln40_1 \
    op interface \
    ports { bitcast_ln40_1 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln40_2 \
    op interface \
    ports { bitcast_ln40_2 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln40_3 \
    op interface \
    ports { bitcast_ln40_3 { I 32 vector } } \
} "
}
...
set InstName predict_kernel_flow_control_loop_pipe_sequential_init_U
set CompName predict_kernel_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix predict_kernel_ \
}"
} else {
